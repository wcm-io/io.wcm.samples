 ...
 * #L%
 */
package io.wcm.samples.core.controller.http;
...
public class RedirectTest {
  ...
  public void testRedirectDefault() {
    context.currentPage("/content/wcm-io-samples/en/archive/sampleApp---2012");
  ...
  public void testRedirectInvalid() throws Exception {
    context.currentPage("/content/wcm-io-samples/en/archive");
