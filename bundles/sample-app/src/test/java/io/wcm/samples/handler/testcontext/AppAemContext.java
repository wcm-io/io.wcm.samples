...
import io.wcm.samples.handler.config.impl.ApplicationProviderImpl;
import io.wcm.samples.handler.config.impl.ConfigurationFinderStrategyImpl;
import io.wcm.samples.handler.config.impl.MediaFormatProviderImpl;
